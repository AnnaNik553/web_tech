...
$work_experience = [
        ...
        [
        'name' => 'Graphic Designer / designsomething.',
        'start_date' => 'Jun 2010',
        'end_date' => 'Mar 2012',
  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php $work_experience[$i]['name']; ?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?= $work_experience[$i]['start_date']; ?> - 
            <?php if ($work_experience[$i]['end_date'] == 'Current'): ?>
